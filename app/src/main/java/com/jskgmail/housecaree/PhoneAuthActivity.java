...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneNumberField.setText("+91"+mob);
...
///////////////////////////////////////////////////////////////////////////////hoooooooooooooooooo
                ...
                Toast.makeText(getApplicationContext(),"Successfully updated your account",Toast.LENGTH_LONG).show();
                finish();
    ...
    private boolean validatePhoneNumber() {
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            mPhoneNumberField.setError("Invalid mobile number (start with +91).");
            return false;
        }
